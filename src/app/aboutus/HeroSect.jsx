...
export default function HeroSect() {
  return (
    <div className="relative min-h-screen mt-20 mb-16 overflow-hidden">
      {imagedata?.length === 0 ? (
        ...
        >
          <div className="relative px-4 mx-auto max-w-7xl  sm:static sm:px-6 lg:px-8">
            <motion.div className="sm:max-w-lg">
              <motion.h1
                className="text-4xl text-green-700 md:max-w-[390px] leading-16 font-roboto  max-w-[290px] xl:max-w-lg font-bold tracking-tight md:text-5xl xl:text-6xl"
